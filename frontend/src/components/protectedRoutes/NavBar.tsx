"use client"
import { AudioLines, CalendarDays, CreditCard, FolderGit2, LayoutDashboard, ListChecks, MessagesSquare, NotebookPen, Puzzle, Sparkles, User, Users } from 'lucide-react'
...
const NavBar = () => {
    ...
    return (
        <nav className='py-1 px-5 fixed bottom-0 w-full'>
            <div className="bg-gray-100/80 w-full py-2 px-5 rounded-md flex items-center justify-between shadow-sm backdrop-blur-sm border-2 border-gray-300">
                ...
                <div className="max-w-10 max-h-10">
                    <div className='cursor-pointer p-2 rounded-full shadow-lg flex items-center justify-center bg-gradient-to-tr from-gray-200 via-gray-400 to-gray-800'>
