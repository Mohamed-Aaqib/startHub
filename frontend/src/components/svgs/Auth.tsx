...
export const NameIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg height={60} viewBox="0 -9 32 32" width={40} xmlns="http://www.w3.org/2000/svg" {...props}>
...
export const EmailIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg height={20} viewBox="0 0 32 32" width={20} xmlns="http://www.w3.org/2000/svg" {...props}>
        <g id="Layer_3" data-name="Layer 3">
...
export const PasswordIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg height={20} viewBox="-64 0 512 512" width={20} xmlns="http://www.w3.org/2000/svg" {...props}>
...
export const ConfirmPasswordIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg height={20} viewBox="0 0 512 512" width={20} xmlns="http://www.w3.org/2000/svg" {...props}>
        <path d="M336 512H48c-26.5 0-48-21.5-48-48V240c0-26.5 21.5-48 48-48h288c26.5 0 48 21.5 48 48v224c0 26.5-21.5 48-48 48zM48 224c-8.8 0-16 7.2-16 16v224c0 8.8 7.2 16 16 16h288c8.8 0 16-7.2 16-16V240c0-8.8-7.2-16-16-16H48z" fill="currentColor"/>
        <path d="M304 224c-8.8 0-16-7.2-16-16v-80c0-52.9-43.1-96-96-96s-96 43.1-96 96v80c0 8.8-7.2 16-16 16s-16-7.2-16-16v-80C64 70.6 121.4 13 192 13s128 57.6 128 128v80c0 8.8-7.2 16-16 16z" fill="currentColor"/>
        <path d="M466.7 180.4c-9.2-9.2-24.2-9.2-33.4 0l-40.4 40.4c-5.6 5.6-8.4 13.1-8.4 20.6s2.8 15.1 8.4 20.6c11.2 11.2 29.6 11.2 40.8 0l8.4-8.4 17.3 17.3-25.6 25.6c-6.2 6.2-6.2 16.4 0 22.6l11.3 11.3c6.2 6.2 16.4 6.2 22.6 0l57.4-57.4c6.2-6.2 6.2-16.4 0-22.6zm-43.1 60.5c-1.6 1.6-4.1 1.6-5.7 0s-1.6-4.1 0-5.7l40.4-40.4c1.6-1.6 4.1-1.6 5.7 0s1.6 4.1 0 5.7z" fill="currentColor"/>
    </svg>
);  

export const GoogleIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg version="1.1" width={20} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" {...props}>
